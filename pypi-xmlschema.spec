...
Version  : 2.0.3
Release  : 29
URL      : https://files.pythonhosted.org/packages/8a/95/77a1d2f76b109c31c8cb43034007e17e1791b50569c6e719911202719fae/xmlschema-2.0.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/95/77a1d2f76b109c31c8cb43034007e17e1791b50569c6e719911202719fae/xmlschema-2.0.3.tar.gz
...
%prep
%setup -q -n xmlschema-2.0.3
cd %{_builddir}/xmlschema-2.0.3
pushd ..
cp -a xmlschema-2.0.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661473823
...
cp %{_builddir}/xmlschema-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-xmlschema/7507376d580cb5b5c2ff25e049bf82420bf2ca56 || :
