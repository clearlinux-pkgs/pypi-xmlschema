...
Version  : 4.1.0
Release  : 66
URL      : https://files.pythonhosted.org/packages/dd/cb/dc0236ae209c924c1a7f4d3ae9d3371980beda85d1e0b5bd2d4f07372e48/xmlschema-4.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/dd/cb/dc0236ae209c924c1a7f4d3ae9d3371980beda85d1e0b5bd2d4f07372e48/xmlschema-4.1.0.tar.gz
...
%prep
%setup -q -n xmlschema-4.1.0
cd %{_builddir}/xmlschema-4.1.0
pushd ..
cp -a xmlschema-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749224166
