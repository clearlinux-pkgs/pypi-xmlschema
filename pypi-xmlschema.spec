...
%prep
%setup -q -n xmlschema-1.10.0
cd %{_builddir}/xmlschema-1.10.0
...
cp %{_builddir}/xmlschema-1.10.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-xmlschema/7507376d580cb5b5c2ff25e049bf82420bf2ca56
