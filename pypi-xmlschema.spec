...
Source0  : https://files.pythonhosted.org/packages/27/08/46dc111a9737a3c210f6bf5cf5af88ff9396033f58c031d6ba7c942ea1e3/xmlschema-2.1.0.tar.gz
...
%prep
%setup -q -n xmlschema-2.1.0
cd %{_builddir}/xmlschema-2.1.0
pushd ..
cp -a xmlschema-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664207044
