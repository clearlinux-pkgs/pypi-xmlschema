...
Source0  : https://files.pythonhosted.org/packages/e1/7f/66106286937710b298c9f2aab33a97327c786f3e8a8baa21abc68c3b173a/xmlschema-2.0.4.tar.gz
...
%prep
%setup -q -n xmlschema-2.0.4
cd %{_builddir}/xmlschema-2.0.4
pushd ..
cp -a xmlschema-2.0.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662652618
