...
Source0  : https://files.pythonhosted.org/packages/e5/f7/2edf59659525cf300f2e3e41e4278907a75db2c4ff50bdd9bc77f12e56a5/xmlschema-1.7.1.tar.gz
...
%prep
%setup -q -n xmlschema-1.7.1
cd %{_builddir}/xmlschema-1.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1630686664
...
cp %{_builddir}/xmlschema-1.7.1/LICENSE %{buildroot}/usr/share/package-licenses/xmlschema/7507376d580cb5b5c2ff25e049bf82420bf2ca56
